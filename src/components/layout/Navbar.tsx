      ...
      <div className="bg-primary text-white text-sm py-2 px-4 hidden md:block">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 text-white/80">
            ...
            <span>
              {t("nav.emergency")}: <strong className="text-accent">022-MEDIEMG</strong>
            </span>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/appointment">
              <Button
                size="sm"
                className="bg-accent hover:bg-accent/90 text-white h-7 text-xs px-3"
                data-testid="btn-book-appointment-top"
              >
            ...
            <Button
              size="sm"
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 h-7 text-xs px-3 bg-transparent"
            >
              {t("nav.iWantToFind")}
            </Button>
            <Link href="/portal">
          ...
          <div className="flex items-center justify-between h-16">
            <Link href="/" className="flex items-center gap-3">
              <div className="flex-shrink-0">
                <img src={logo} alt="Saroja Hospital Logo" className="h-12 w-auto object-contain" />
              </div>

              <div className="hidden sm:block">
                <h1 className="text-lg font-bold text-primary leading-tight">Saroja Hospital</h1>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/appointment" className="hidden md:block">
                <Button
                  size="sm"
                  className="bg-primary text-white h-8 text-xs px-4"
                  data-testid="btn-book-appointment-nav"
                >
                  {t("nav.bookAppointment")}
                </Button>
              </Link>
