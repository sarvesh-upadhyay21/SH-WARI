...
const trials = [
  ...
  {
    id: 2,
    title: "Minimally Invasive vs. Open Cardiac Surgery Outcomes Study",
    phase: "Phase II",
    status: "Active",
    dept: "Cardiology",
    pi: "Dr. Sarah Jenkins",
  ...
  {
    id: 4,
    title: "Robotic Partial Nephrectomy Long-Term Renal Function Study",
    phase: "Phase III",
    status: "Active",
    dept: "Urology",
    pi: "Dr. Robert Foster",
...
const publications = [
  {
    title: "Long-term Outcomes of Robotic-Assisted Prostatectomy: A 10-Year Analysis",
    journal: "Journal of Urology",
    year: 2025,
    authors: "Foster R. et al.",
  },
  {
    title: "Novel Immunotherapy Combinations in Triple-Negative Breast Cancer",
    journal: "Lancet Oncology",
    year: 2025,
    authors: "Rostova E. et al.",
  },
  {
    title: "Stroke Outcomes in a High-Volume Comprehensive Stroke Center: 2020–2025",
    journal: "NEJM",
    year: 2024,
          ...
          <div className="grid md:grid-cols-4 gap-5 mb-16">
            {statLabels.map((label, i) => {
              ...
              return (
                <Card
                  key={label}
                  className="text-center border border-border p-6"
                  data-testid={`research-stat-${i}`}
                >
          ...
          <div className="mb-14">
            ...
            <div className="space-y-4">
              {trials.map((trial, i) => (
                ...
                >
                  <Card
                    className="border border-border hover:shadow-lg hover:border-primary/30 transition-all"
                    ...
                    <CardContent className="p-6 flex flex-col sm:flex-row sm:items-center gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap gap-2 mb-2">
                          ...
                          <Badge
                            className={`text-xs ${trial.status === "Recruiting" ? "bg-green-100 text-green-700 dark:bg-green-900/20 dark:text-green-400" : "bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400"} border-0`}
                          >
                            {trial.status}
                          </Badge>
                      ...
                      {trial.status === "Recruiting" && (
                        <Button
                          ...
                          data-testid={`btn-trial-enquire-${trial.id}`}
                        >
