...
function HeroSlider() {
  ...
  const bgs = [
    "from-blue-900 via-primary to-blue-800",
    "from-teal-900 via-emerald-800 to-primary",
    "from-indigo-900 via-blue-800 to-primary",
  ];
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/appointment">
                <Button
                  size="lg"
                  className="bg-accent hover:bg-accent/90 text-white px-8 text-base"
              ...
              <Link href="/doctors">
                <Button
                  ...
                  data-testid="btn-hero-find-doctor"
                >
              ...
              <Link href="/departments">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white/50 text-white hover:bg-white/10 bg-transparent px-8 text-base hidden md:flex"
...
function QuickAccess() {
  ...
  const cards = [
    {
      icon: Calendar,
      label: t("home.quickAccess.bookAppointment"),
      desc: t("home.quickAccess.bookDesc"),
      href: "/appointment",
      color: "text-primary bg-primary/10",
    },
    {
      icon: Phone,
      label: t("home.quickAccess.emergencyCare"),
      desc: t("home.quickAccess.emergencyDesc"),
      href: "/contact",
      color: "text-red-600 bg-red-50 dark:bg-red-900/20",
    },
    {
      icon: Search,
      label: t("home.quickAccess.findDoctor"),
      desc: t("home.quickAccess.findDesc"),
      href: "/doctors",
      color: "text-accent bg-accent/10",
    },
    {
      icon: Shield,
      label: t("home.quickAccess.patientPortal"),
      desc: t("home.quickAccess.portalDesc"),
      href: "/portal",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 -mt-16 relative z-10">
          {cards.map((c, i) => (
            ...
            >
              <Link href={c.href}>
                <Card
                  className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer border border-border bg-white dark:bg-slate-800"
                  data-testid={`card-quick-${i}`}
                >
                  <CardContent className="p-5 flex flex-col items-center text-center gap-3">
                    <div
                      className={`w-12 h-12 rounded-xl ${c.color} flex items-center justify-center`}
                    >
                      <c.icon size={22} />
                    </div>
                    <div>
            ...
            return (
              ...
              >
                <Link href={`/departments/${svc.id}`}>
                  <Card
                    className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer group border border-border overflow-hidden"
                    data-testid={`card-service-${svc.id}`}
                  >
                    <CardContent className="p-5">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-br ${svc.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
                      >
        ...
        <div className="text-center mt-10">
          <Link href="/departments">
            <Button
              ...
              data-testid="btn-view-all-services"
            >
...
function CentresOfExcellence() {
  ...
  const centresEn = [
    {
      name: "Cardiology",
      desc: "Comprehensive cardiac care including interventional procedures, bypass surgery, and electrophysiology.",
    },
    {
      name: "Oncology",
      desc: "Multidisciplinary cancer care with cutting-edge immunotherapy, robotic surgery, and radiation oncology.",
    },
    {
      name: "Neurology & Neurosurgery",
      desc: "Comprehensive brain and spine care, stroke management, and advanced neurosurgical procedures.",
    },
    {
      name: "Orthopedics",
      desc: "Robotic joint replacement, spine surgery, sports medicine, and complex trauma management.",
    },
    {
      name: "Organ Transplant",
      desc: "Liver, kidney, heart, and bone marrow transplant programs with exceptional long-term outcomes.",
    },
    {
      name: "Robotic Surgery",
      desc: "Multi-specialty robotic surgical center using the latest da Vinci Xi and ROSA surgical systems.",
    },
    {
      name: "Emergency Medicine",
      desc: "Level I Trauma Center with dedicated cardiac, neuro, and pediatric emergency teams — 24/7.",
    },
  ];
  const centresHi = [
    {
      name: "हृदय रोग विभाग",
      desc: "इंटरवेंशनल प्रक्रियाओं, बाईपास सर्जरी और इलेक्ट्रोफिजियोलॉजी सहित व्यापक हृदय देखभाल।",
    },
    {
      name: "ऑन्कोलॉजी",
      desc: "अत्याधुनिक इम्यूनोथेरेपी, रोबोटिक सर्जरी और रेडिएशन ऑन्कोलॉजी के साथ बहु-विषयक कैंसर देखभाल।",
    },
    {
      name: "न्यूरोलॉजी और न्यूरोसर्जरी",
      desc: "व्यापक मस्तिष्क और रीढ़ की देखभाल, स्ट्रोक प्रबंधन और उन्नत न्यूरोसर्जिकल प्रक्रियाएं।",
    },
    {
      name: "ऑर्थोपेडिक्स",
      desc: "रोबोटिक जॉइंट रिप्लेसमेंट, स्पाइन सर्जरी, स्पोर्ट्स मेडिसिन और जटिल ट्रॉमा प्रबंधन।",
    },
    {
      name: "अंग प्रत्यारोपण",
      desc: "असाधारण दीर्घकालिक परिणामों के साथ लिवर, किडनी, हृदय और अस्थि मज्जा प्रत्यारोपण।",
    },
    {
      name: "रोबोटिक सर्जरी",
      desc: "नवीनतम da Vinci Xi और ROSA सर्जिकल सिस्टम का उपयोग करने वाला बहु-विशेषज्ञता रोबोटिक सर्जिकल केंद्र।",
    },
    {
      name: "आपातकालीन चिकित्सा",
      desc: "Level I ट्रॉमा सेंटर जिसमें समर्पित कार्डियक, न्यूरो और पीडियाट्रिक आपातकालीन टीमें — 24/7।",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-end justify-between mb-12">
          ...
          <div className="hidden md:flex gap-2">
            ...
            <button
              onClick={() => setCurrent((c) => Math.min(centres.length - visible, c + 1))}
              className="w-10 h-10 rounded-full border border-white/30 flex items-center justify-center hover:bg-white/10 transition-colors"
              aria-label="Next"
            >
          ...
          >
            {centres.map((c, i) => (
              <div key={c.name} className="flex-none w-[calc(33.333%-14px)] min-w-[280px]">
                <Card
                  className="bg-white/10 border-white/20 hover:bg-white/20 transition-all cursor-pointer group h-full"
                  data-testid={`card-centre-${i}`}
                >
                  <CardContent className="p-6">
                    ...
                    <button className="mt-4 flex items-center gap-1 text-accent text-sm font-medium group-hover:gap-3 transition-all">
                      <span>{t("home.centres.explore")}</span>
                      <ArrowRight size={14} />
                    </button>
                  </CardContent>
                </Card>
...
function DoctorsSection() {
  ...
  const filtered =
    dept === "all" ? doctors.slice(0, 6) : doctors.filter((d) => d.department === dept).slice(0, 6);
      ...
      <div className="max-w-7xl mx-auto px-4">
            ...
            <SelectContent>
              {depts.map((d) => (
                <SelectItem key={d} value={d}>
                  {d === "all" ? t("home.doctors.allDepartments") : d}
                </SelectItem>
              ))}
            </SelectContent>
          </Select>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((doc, i) => (
            ...
            >
              <Card
                className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group border border-border"
                  ...
                  <div className="flex gap-2">
                    <Link href={`/doctors/${doc.id}`} className="flex-1">
                      <Button
                        ...
                        data-testid={`btn-doctor-profile-${doc.id}`}
                      >
                    ...
                    <Link href="/appointment" className="flex-1">
                      <Button
                        ...
                        data-testid={`btn-doctor-book-${doc.id}`}
                      >
        ...
        <div className="text-center mt-10">
          <Link href="/doctors">
            <Button
              variant="outline"
              className="border-primary text-primary hover:bg-primary hover:text-white"
              data-testid="btn-view-all-doctors"
            >
...
function WhyChooseUs() {
  ...
  const ref = useRef(null);
  const inView = useInView(ref, { once: true });
  const features: { title: string; desc: string }[] = t("home.whyUs.features", {
    returnObjects: true,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <Card
                  className="text-center p-6 h-full border border-border hover:shadow-xl hover:border-primary/30 transition-all group"
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {blogs.map((blog, i) => (
            ...
            >
              <Card
                className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group cursor-pointer border border-border"
              ...
              >
                <div className="h-40 bg-gradient-to-br from-primary/20 to-accent/20 rounded-t-lg flex items-center justify-center">
                  <div className="text-primary/30 font-serif text-5xl font-bold">
                    {blog.category[0]}
                  </div>
                </div>
                <CardContent className="p-5">
                  ...
                  <h3 className="font-bold text-sm text-foreground mb-2 group-hover:text-primary transition-colors line-clamp-2">
                    {blog.title}
                  </h3>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {events.map((event, i) => (
            ...
            >
              <Card
                className="border border-border hover:shadow-xl transition-all duration-300 h-full"
                data-testid={`card-event-${event.id}`}
              >
                <CardContent className="p-6">
                  <Badge
                    className={`text-xs mb-4 ${event.type === "Conference" ? "bg-primary/10 text-primary" : event.type === "Workshop" ? "bg-accent/10 text-accent" : "bg-purple-50 text-purple-700 dark:bg-purple-900/20 dark:text-purple-400"}`}
                  >
                    {event.type}
                  </Badge>
                  ...
                  <Button
                    size="sm"
                    className={`mt-4 w-full text-xs ${event.registrationOpen ? "bg-primary text-white" : "bg-muted text-muted-foreground"}`}
                    disabled={!event.registrationOpen}
                    data-testid={`btn-event-register-${event.id}`}
                  >
...
function InternationalSection() {
  const { t } = useTranslation();
  const serviceLabels: string[] = t("home.international.services", {
    returnObjects: true,
  }) as string[];
  const serviceDescs: string[] = t("home.international.serviceDescs", {
    returnObjects: true,
  }) as string[];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <Badge className="bg-accent/10 text-accent border-0 mb-4">
              {t("home.international.badge")}
            </Badge>
            <h2 className="text-4xl font-bold font-serif text-foreground mb-5">
              {t("home.international.title")}
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              {t("home.international.desc")}
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {serviceLabels.map((label, i) => {
              ...
              return (
                <Card
                  key={label}
                  className="border border-border p-5 hover:shadow-lg transition-all"
                  data-testid={`card-intl-${i}`}
                >
                  <CardContent className="p-0">
    ...
    <section className="py-16 border-y border-border overflow-hidden bg-background">
      <div className="max-w-7xl mx-auto px-4 mb-10 text-center">
        <p className="text-sm text-muted-foreground uppercase tracking-widest font-medium">
          {t("home.insurance.label")}
        </p>
      </div>
      <div className="flex gap-12 animate-[scroll_25s_linear_infinite] whitespace-nowrap">
        {[...partners, ...partners].map((p, i) => (
          <span key={i} className="text-muted-foreground font-semibold text-sm flex-none px-2">
            {p}
          </span>
        ))}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <div className="flex gap-4">
            {[
              ["Book Appts", "Find Doctors", "My Records"],
              ["Lab Results", "Prescriptions", "Video Consult"],
            ].map((col, ci) => (
              <div
                key={ci}
                className={`w-36 bg-white/10 rounded-2xl p-4 space-y-3 ${ci === 1 ? "mt-8" : ""}`}
              >
                {col.map((item) => (
        ...
        <Accordion type="single" collapsible className="space-y-3">
          {faqs.map((faq, i) => (
            <AccordionItem
              key={i}
              value={`item-${i}`}
              className="border border-border rounded-xl px-5 bg-white dark:bg-slate-800"
  ...
  const items = [
    {
      ...
      value: "One SarojaPlaza, Excellence Boulevard, Boston, MA 02115",
    },
