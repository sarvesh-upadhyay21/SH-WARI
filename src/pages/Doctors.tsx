              ...
              <SelectContent>
                {depts.map((d) => (
                  <SelectItem key={d} value={d}>
                    {d === "all" ? t("doctors.allDepartments") : d}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-sm text-muted-foreground mb-8">
            {t(filtered.length === 1 ? "doctors.showing" : "doctors.showingPlural", {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filtered.map((doc, i) => (
              ...
              >
                <Card
                  className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group border border-border h-full"
                    ...
                    <div className="flex gap-2 mt-auto">
                      <Link href={`/doctors/${doc.id}`} className="flex-1">
                        <Button
                          ...
                          data-testid={`btn-doctor-view-${doc.id}`}
                        >
