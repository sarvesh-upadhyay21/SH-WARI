...
const jobs = [
  {
    ...
    location: "Boston, MA",
    exp: "5+ Years",
    desc: "Seeking an experienced interventional cardiologist to join our nationally recognized cardiac center. Candidates should be board-certified with a focus on complex coronary interventions.",
  },
  {
    id: 2,
    ...
    location: "Boston, MA",
    exp: "3+ Years",
    desc: "Join our dedicated cancer care team. This role involves supporting patients through chemotherapy and immunotherapy, symptom management, and patient education.",
  },
  {
    id: 3,
    title: "Robotic Surgery Coordinator",
    dept: "Urology",
    type: "Full-Time",
    location: "Boston, MA",
    exp: "2+ Years",
    desc: "Coordinate scheduling, training, and quality assurance for our da Vinci robotic surgery program.",
  },
  {
    id: 4,
    title: "Radiologist — MRI Specialist",
    dept: "Radiology",
    type: "Full-Time",
    location: "Boston, MA",
    exp: "4+ Years",
    desc: "Seeking a fellowship-trained radiologist with specialized expertise in MRI neuroimaging and musculoskeletal radiology.",
  },
  {
    id: 5,
    ...
    location: "Boston, MA",
    exp: "2+ Years",
    desc: "Provide psychosocial support to patients and families, assist with discharge planning, connect patients to community resources.",
  },
  {
    id: 6,
    ...
    location: "Boston, MA",
    exp: "1+ Years",
    desc: "Analyze clinical and operational data to support quality improvement initiatives.",
  },
];
              ...
              <SelectContent>
                {depts.map((d) => (
                  <SelectItem key={d} value={d}>
                    {d === "all" ? t("careers.allDepartments") : d}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
      ...
      <section className="py-16 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <p className="text-sm text-muted-foreground mb-6">
            {t(filtered.length === 1 ? "careers.positions" : "careers.positionsPlural", {
          ...
          <div className="space-y-4">
            {filtered.map((job) => (
              <Card
                key={job.id}
                className="border border-border hover:shadow-xl hover:border-primary/30 transition-all"
            ...
            <>
              <div className="mb-5">
                ...
                <h2 className="text-2xl font-bold font-serif text-foreground">
                  {t("careers.form.title", { title: applyJob?.title })}
                </h2>
              </div>
              <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder={t("careers.form.coverPlaceholder")}
                            rows={4}
                            {...field}
