            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3 mb-4">
                ...
                {doctor.qualifications.map((q) => (
                  <Badge key={q} className="bg-white/10 text-white border-0 text-xs">
                    {q}
                  </Badge>
                ))}
              </div>
            ...
            <div className="flex flex-col gap-3">
              <Link href="/appointment">
                <Button
                  ...
                  data-testid="btn-doctor-detail-book"
                >
              ...
              <Button
                ...
                data-testid="btn-doctor-emergency"
              >
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2">
                    {weekdays.map((day) => (
                      ...
                      >
                        ...
                        <span
                          className={`text-xs ${availability[day] ? "text-accent" : "text-muted-foreground"}`}
                        >
                  ...
                  <Link href="/appointment" className="block mt-5">
                    <Button
                      ...
                      data-testid="btn-schedule-book"
                    >
                      {t("doctors.bookThisDoctor")}
                    </Button>
                  </Link>
                </CardContent>
              </Card>
