                ...
                <Card key={item.label} className="border border-border">
                  <CardContent className="p-5 flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p
                        className={`text-sm font-semibold text-foreground whitespace-pre-line ${item.red ? "text-red-600" : ""}`}
                      >
                        {item.value}
                      </p>
                    </div>
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                  <FormControl>
                                    <SelectTrigger data-testid="select-contact-dept">
                                      <SelectValue
                                        placeholder={t("contact.form.deptPlaceholder")}
                                      />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent>
                                    {Object.entries(
                                      t("contact.deptOptions", { returnObjects: true }) as Record<
                                        string,
                                        string
                                      >,
                                    ).map(([key, label]) => (
                  ...
                  <div className="h-64 bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Excellence Boulevard, Boston, MA 02115
                      </p>
                    </div>
                  </div>
                </CardContent>
