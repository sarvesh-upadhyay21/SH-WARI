    ...
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            {
              label: t("portal.stats.upcomingVisits"),
              value: "1",
              icon: Calendar,
              color: "text-blue-600",
            },
            {
              label: t("portal.stats.activePrescriptions"),
              value: "2",
              icon: Pill,
              color: "text-green-600",
            },
            {
              label: t("portal.stats.pendingReports"),
              value: "0",
              icon: TestTube,
              color: "text-purple-600",
            },
            {
              label: t("portal.stats.outstandingBills"),
              value: "$0",
              icon: Receipt,
            ...
            <Card
              ...
              data-testid={`portal-stat-${stat.label.toLowerCase().replace(/\s+/g, "-")}`}
            >
              ...
              <CardContent className="p-2">
                {sidebarItems.map((item) => (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${active === item.id ? "bg-primary text-white" : "text-foreground hover:bg-muted"}`}
          ...
          <div className="flex-1">
            <Card className="border border-border">
              <CardContent className="p-6">
                {active === "appointments" && (
                  <div>
                    <h2 className="text-xl font-bold font-serif text-foreground mb-5">
                ...
                {active === "prescriptions" && (
                  <div>
                    <h2 className="text-xl font-bold font-serif text-foreground mb-5">
                      {t("portal.nav.prescriptions")}
                    </h2>
                    <div className="space-y-3">
                      {mockData.prescriptions.map((rx) => (
                        <div
                          key={rx.id}
                          className="p-4 rounded-xl border border-border bg-green-50/50 dark:bg-green-900/10"
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Duration: {rx.duration} | Prescribed by: {rx.doctor}
                              </p>
                            </div>
                          </div>
                        </div>
